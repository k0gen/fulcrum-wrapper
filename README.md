...
To build the `fulcrum` package for all platforms using embassy-sdk version >=0.3.3, run the following command:

```
make
```

To build the `fulcrum` package for a single platform using embassy-sdk version <=0.3.2, run:
